...
/**
 * Pinterest → Events page (PageView / WooCommerce / Custom)
 * Flat layout, single form + single "Update All" button.
 */
function unipixel_page_pinterest_events()
{
    global $wpdb;
...
?>
    <div class="UniPixelShell position-relative" data-platform="pinterest">
        ...
        <?php unipixel_render_platform_header_nav('pinterest', "events"); ?>
        ...
        <form id="unipixel-events-all-form" class="position-relative">
            ...
            <!-- ============================= -->
            <section id="pinterest-pageview-section" class="mb-5">
                <h2 class="mb-2"><?php echo esc_html__('PageView Event for', 'unipixel'); ?> <?php echo esc_html($platformName); ?></h2>
                <p class="mb-3">
                    <strong><?php echo esc_html__('page_visit', 'unipixel'); ?></strong>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="colSendClientSide">Send<br />Client-side <?php echo wp_kses(unipixel_get_help_icon('Pinterest_PageView_ClientSideTurnOn'), $icon_allow); ?></th>
                            <th class="colSendServerSide">Send<br />Server-side <?php echo wp_kses(unipixel_get_help_icon('Pinterest_PageView_ServerSideTurnOn'), $icon_allow); ?></th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo esc_html__('Send a page_visit event with page details when a page is loaded.', 'unipixel'); ?></td>
                            <td>
            ...
            <!-- ===================================== -->
            <section id="pinterest-woo-section" class="mb-5">
            ...
            <!-- ================================= -->
            <section id="pinterest-custom-section" class="mb-3">
                ...
                <table id="event-settings-table" class="table">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo esc_html__('Platform Event Ref', 'unipixel'); ?><br><small class="fw-normal"><?php echo esc_html__('sent to', 'unipixel'); ?> <?php echo esc_html($platformName); ?>. <?php echo esc_html__('e.g.', 'unipixel'); ?> <code>lead</code>, <code>MyBespokeEvent</code></small></th>
