...
/**
 * TikTok → Events page (PageView / WooCommerce / Custom)
 * Flat layout, single form + single "Update All" button.
 */
function unipixel_page_tiktok_events()
{
    global $wpdb;
...
?>
    <div class="UniPixelShell position-relative" data-platform="tiktok">
        ...
        <?php unipixel_render_platform_header_nav('tiktok', "events"); ?>
        ...
        <form id="unipixel-events-all-form" class="position-relative">
            ...
            <!-- ============================= -->
            <section id="tiktok-pageview-section" class="mb-5">
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class="colSendClientSide">Send<br />Client-side <?php echo wp_kses(unipixel_get_help_icon('TikTok_PageView_ClientSideTurnOn'), $icon_allow); ?></th>
                            <th class="colSendServerSide">Send<br />Server-side <?php echo wp_kses(unipixel_get_help_icon('TikTok_PageView_ServerSideTurnOn'), $icon_allow); ?></th>
            ...
            <!-- ===================================== -->
            <section id="tiktok-woo-section" class="mb-5">
